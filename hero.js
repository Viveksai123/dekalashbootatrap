const reviewsData = [
    ...
    stars: 4,
      platform: "Google",
       backgroundImage: "./img/image/bg3.png"
    },
    {
      id: 5,
      name: "Anna K",
...
function updateReview() {
    ...
    switch (review.platform) {
        ...
        case 'Twitter':
            platformIcon = `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    <path fill="#1DA1F2" d="M23 5.3c-.8.3-1.6.6-2.5.7.9-.5 1.6-1.3 1.9-2.3-.8.5-1.7.9-2.7 1.1-.8-.8-1.9-1.3-3.1-1.3-2.3 0-4.2 1.9-4.2 4.2 0 .3 0 .6.1 .9-3.5-.2-6.6-1.8-8.7-4.3-.4.6-.6 1.3-.6 2.1 0 1.4.7 2.7 1.8 3.5-.7 0-1.3-.2-1.9-.5v.1c0 2 1.4 3.7 3.3 4.1-.3.1-.7.1-1 .1-.2 0-.5 0-.7-.1.5 1.5 1.8 2.6 3.4 2.6-1.3 1-2.9 1.6-4.6 1.6-.3 0-.6 0-.9-.1 1.9 1.2 4.1 1.9 6.5 1.9 7.8 0 12-6.5 12-12.1l-.1-.6c.8-.6 1.5-1.3 2.1-2.1z"/>
                </svg>`;
            break;
        default:
            platformIcon = `
    ...
    document.getElementById('home').style.backgroundImage = `url('${review.backgroundImage}')`;
